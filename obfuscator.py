...
def obfuscate(p):
    ...
    _main = f'main=lambda _:__builtins__.getattr(__builtins__,{chr_str("exec")})(__builtins__.getattr(__builtins__.getattr(__builtins__,{chr_str("bytes")}),{chr_str("fromhex")})(_),__builtins__.getattr(__builtins__,{chr_str("globals")})())'.encode(ENCODING).hex()
