...
from os.path import isfile, split as splitp, join as joinp, abspath
...
def pypacker():
    if len(argv) < 2: 
        print(f'python{version_info.major} {splitp(__file__)[-1]} (path)  —  Pack Python file')
        return
